    ...
    return (
        ...
        >
            <div className="game-online-result">
                ...
                >{props.teamA.players.map((player, i) => <p key={i} className="name">{player.player.username}</p>)}</div>
                ...
                >{props.teamB.players.map((player, i) => <p key={i} className="name">{player.player.username}</p>)}</div>
            </div>
