...
const TournamentPage = () => {
  ...
  useEffect(() => {
    setTournaments([
      ...tournaments,
      { title: "مسابقات دهه فجر 1400", progress: "60%", selected: true },
      { title: "مسابقات دهه فجر 1400", progress: "40%", selected: false },
      { title: "مسابقات دهه فجر 1400", progress: "0%", selected: false },
      { title: "مسابقات دهه فجر 1400", progress: "0%", selected: false },
      { title: "مسابقات دهه فجر 1400", progress: "0%", selected: false },
    ]);
    setContent([
