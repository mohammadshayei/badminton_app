    ...
    switch (index) {
      ...
      case 2:
        ...
        if (props.exitable) {
          ...
          if (info.team1.scores.length === 0 || info.team2.scores.length === 0)
            return;
          let teamWon =
          ...
          players = [
            {
              id: info[teamWon].players[0].id,
              text: info[teamWon].players[0].name,
              selected: false,
            },
          ];
          if (max === 3)
            players = [
              ...players,
              {
                id: info[teamWon].players[1].id,
                text: info[teamWon].players[1].name,
                selected: false,
              },
            ];
        }
