export const stringFa = {
  ...
  nationality: "ملیت",
  sex: "جنسیت",
  sex_error: "جنسیت را پر کنید",
  username: "نام کاربری",
  first_name: "نام",
  last_name: "نام خانوادگی",
  username_error: "نام کاربری باید بیشتر از 2 حرف باشد",
  frist_name_error: "نام باید بیشتر از 2 حرف باشد",
  nationality_error: "ملیت باید پر شود",
  last_name_error: "نام خانوادگی باید بیشتر از 2 حرف باشد",
  password: "رمز عبور",
  ...
  no_game_to_see: "در حال حاضر بازی زنده وجود ندارد",
  time: "ساعت",
  ...
  search_team: "جستجو تیم",
  item_not_found: "موردی یافت نشد!",
  search_tournament: "جستجو مسابقه",
  home: "تیم میزبان",
  away: "تیم مهمان",
  referee: "سرداور",
  delete: "حذف",
  ...
  callback_status_NOK_message:
    "چنانچه مبلغی از حساب شما کسر شده است، حداکثر طی 72 ساعت آینده به حساب شما باز خواهد گشت.",
